...
def main():
    urls = ["https://ib.pmf.ukim.edu.mk/titles/view/9", "https://ib.pmf.ukim.edu.mk/titles/view/1", "https://ib.pmf.ukim.edu.mk/titles/view/2", "https://ib.pmf.ukim.edu.mk/titles/view/3", "https://ib.pmf.ukim.edu.mk/titles/view/16", "https://ib.pmf.ukim.edu.mk/titles/view/14", "https://ib.pmf.ukim.edu.mk/titles/view/13", "https://ib.pmf.ukim.edu.mk/titles/view/12"]
    ...
    pd.DataFrame(data, columns=["name"]).to_csv(os.path.join(results_path, "biologija.csv"))
