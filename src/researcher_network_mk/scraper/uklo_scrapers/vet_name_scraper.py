...
def main():
    urls = ["https://vfb.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/"]
    results_path = os.path.join(get_project_root(), "data", "researchers", "uklo", "veterina")
    data = []
    for url in urls:
