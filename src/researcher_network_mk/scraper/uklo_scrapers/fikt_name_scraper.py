...
def main():
    urls = ["https://fikt.uklo.edu.mk/za-fikt/osnovni-informacii/kadar/"]
    ...
    pd.DataFrame(data, columns=["name"]).to_csv(os.path.join(results_path, "informatika.csv"))
