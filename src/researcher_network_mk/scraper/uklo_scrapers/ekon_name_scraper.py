...
def main():
    urls = [
        "https://eccfp.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/redovni-profesori/",
        "https://eccfp.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/vonredni-profesori/",
        "https://eccfp.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/docenti/",
        "https://eccfp.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/asistenti/",
        "https://eccfp.uklo.edu.mk/za-fakultetot/osnovni-informacii/kadar/penzioniraniprofesori/",
    ]
    data = []
    results_path = os.path.join(
        get_project_root(), "data", "researchers", "uklo", "ekonomski"
    )
    for url in urls:
